                ...
                <div className={S.container}>
                    ...
                    <div className={S.content}>
                        <div className={S.contentWrapper}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Valores e Princípios Éticos</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Conduta no Mercado de Capitais</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Gestão de Conflitos de Interesse</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Prevenção à Lavagem de Dinheiro e Compliance</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Canal de Denúncias e Ouvidoria</h2>
                                <p className={S.paragraph}>
