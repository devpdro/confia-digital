                ...
                <div className={S.container}>
                    ...
                    <div className={S.content}>
                        <div className={S.contentWrapper}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Atribuições e Responsabilidades</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Prazos Regulamentares</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Confidencialidade e Proteção de Dados</h2>
                                <p className={S.paragraph}>
