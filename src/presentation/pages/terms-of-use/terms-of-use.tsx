                ...
                <div className={S.container}>
                    ...
                    <div className={S.content}>
                        <div className={S.contentWrapper}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Uso do Site e Serviços</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Alterações nos Termos</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Isenção de Responsabilidade</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Limitação de Responsabilidade</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Política de Privacidade</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Jurisdição e Lei Aplicável</h2>
                                <p className={S.paragraph}>
                            ...
                            <section className={S.section}>
                                <h2 className={S.sectionTitle}>Disposições Gerais</h2>
                                <p className={S.paragraph}>
