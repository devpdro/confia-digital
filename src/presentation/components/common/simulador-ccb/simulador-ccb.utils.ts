...
// Piso: valor financiado acrescido de 5% (cláusula de proteção mínima).
...
// ── Quitação por valor presente (CDC art. 52, §2º) ────────────────────
...
// Separa os centavos do número para renderizar com tamanho menor.
...
// Regex tolerant para extrair campos de uma CCB em PDF (texto).
