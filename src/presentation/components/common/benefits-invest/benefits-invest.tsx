...
const BENEFITS = [
    { id: 8, title: "Seu dinheiro rende mais", description: "Deixe seu saldo render automaticamente acima da poupança, sem esforço e sem burocracia.", icon: <IconTrendingUp size={34} stroke={1.8} /> },
    ...
    { id: 11, title: "Acesso facilitado", description: "Abra sua conta HotInvest sem burocracia, sem análise de crédito e para todos os perfis.", icon: <IconUsers size={34} stroke={1.8} /> },
    ...
    { id: 4, title: "Investimentos", description: "Faça seu dinheiro trabalhar para você.", icon: <IconChartBar size={34} stroke={1.8} /> },
    { id: 3, title: "Cartão de débito", description: "Use o saldo da sua conta onde estiver.", icon: <IconCards size={34} stroke={1.8} /> },
    { id: 6, title: "Tudo no seu celular", description: "Gerencie sua conta e investimentos de forma simples e rápida, direto pelo app, onde estiver.", icon: <IconDeviceMobile size={34} stroke={1.8} /> },
            ...
            <div className={styles.container}>
                <div className={styles.head}>
                    <h2 className={styles.title}>
                        <span className={styles.titleAccent}>A</span>
                        <span> conta completa no banco digital <br /> do HotInvest</span>
                    </h2>
                </div>
